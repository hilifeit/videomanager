...
class DottedBoxPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 1; i <= w / dash; i++) {
      canvas.drawLine(
          Offset(12.5 + i * dash, 20), Offset(17.5 + i * dash, 20), nopaint);
      canvas.drawLine(Offset(12.5 + i * dash, h + 20),
          Offset(17.5 + i * dash, h + 20), nopaint);
    }
    for (int i = 1; i <= h / dash; i++) {
      canvas.drawLine(
          Offset(20, 12.5 + i * dash), Offset(20, 17.5 + i * dash), nopaint);
      canvas.drawLine(Offset(w + 20, 12.5 + i * dash),
          Offset(w + 20, 17.5 + i * dash), nopaint);
    }
  }
