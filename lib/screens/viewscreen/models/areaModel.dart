...
class AreaModel {
   ...
   static AreaModel empty(){
    return AreaModel(id:'', name: '', assignedTo: UserModelMini.empty(), assignedBy: UserModelMini.empty(), location: Location.empty(), status: 0, enabled: true, createdAt: DateTime.now(), updatedAt: DateTime.now(), v: 0);
   }
}
