...
class LocationSettings extends ConsumerWidget {
   LocationSettings({required this.locationSetting, Key? key})
      : super(key: key);
  final LocationSetting locationSetting;
  late LocationSetting temp = LocationSetting.fromJson(locationSetting.toJson());
            ...
            child: Column(
              ...
              children: [
                ...
                CustomSwitch(
                  ...
                  onChanged: (val) {temp.starvaFile=val;},
                  space: 566.sw(),
                ),
                SizedBox(
                  height: 85.sw(),
